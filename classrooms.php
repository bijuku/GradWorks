<?php include('Includes/header.php'); ?>
	<div class="row">
		...
		<div class="large-7 columns signup" id="main-content">
			<h1 class="class-title">Classrooms</h1>
			<div>
				...
				<section class="columns large-7" id="activities">
					<h4>Activities</h4>
					<ul>
						<li>Belinda uploaded a <a href="#">document</a> to the notes section</li>
						<li>Karm left a <a href="#">comment</a> on your discussion thread, <a href="">"Fuck this class"</a></li>
				...
				<div id="discussions" class="striped">
					<table width="100%">
						<tbody>
							...
							<tr>
								<td>Business 101 Recitation</td>
								<td>16 hours</td>
								<td></td>
							</tr>
							<tr>
								<td>Connect Homework</td>
